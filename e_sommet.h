...
vertex_t* trouver_voisin(graph_t graphe,vertex_t sommet_depart,int* nb_voisin );// permet de génerer un tableau alloué dynamiquement. Donne aussi le nombre de voisin
